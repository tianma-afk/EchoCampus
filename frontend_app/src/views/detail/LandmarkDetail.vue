        ...
        <div class="info-card">
          <div class="tags-row">
            <div class="campus-info">
              ...
              <span class="university-name">{{ props.landmark.universityName }}路{{ props.landmark.campusName }}</span>
        ...
        <div class="location-card">
          <div class="card-header">
            ...
            <button class="view-map-btn" @click="handleViewLargeMap">
              查看大地图              <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
