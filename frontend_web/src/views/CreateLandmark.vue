    ...
    <form class="create-form" @submit.prevent="handleSubmit">
      <div class="form-card">
        ...
        <div class="form-row">
          <div class="form-group required">
            <label>地标名称</label>
            <input v-model="form.name" type="text" placeholder="请输入地标名称" />
          </div>
        </div>
      ...
      <div class="form-card">
        ...
        <div class="form-row">
          <div class="form-group">
            <label>位置描述</label>
            <input v-model="form.location" type="text" placeholder="如：校园中心" />
          </div>
        </div>
      ...
      <div class="form-card">
        ...
        <div class="form-row two-col">
          <div class="form-group">
            <label>开放时间</label>
            <input v-model="form.openTime" type="text" placeholder="如：08:00-22:00" />
          </div>
          <div class="form-group">
            <label>开放时间详情</label>
            <input
        ...
        <div class="form-row">
          <div class="form-group">
            <label>建成年份</label>
            <input v-model="form.buildYear" type="text" placeholder="如：2010" />
          </div>
        </div>
      </div>
